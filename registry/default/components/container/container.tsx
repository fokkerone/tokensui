...
const containerVariants = cva('mx-auto', {
  variants: {
    variant: {
      ...
      constrainedPadded: 'max-w-8xl px-4 sm:px-6 lg:px-8',
      fullMobileConstrainedBreakpointPadded: 'max-w-xl sm:px-6 lg:px-8',
      constrainedBreakpointPadded: 'max-w-xl px-4 sm:px-6 lg:px-8',
