---
title: Installation
description: This guide will help you get started with TOUI's copy-and-paste components in just a few minutes.
---

## Prerequisites

Before you can install and use TOUI, make sure your project meets the following requirements:
...
TOUI is fully compatible with Shadcn and extends it with advanced component options.
...
<Alert variant="success" appearance="light" close={false}>
  ...
  <AlertTitle>
    ...
    the default font in your TOUI project.
  </AlertTitle>
</Alert>
...
Explore the [TOUI Components](/docs/accordion) and add the ones you need into your project.
