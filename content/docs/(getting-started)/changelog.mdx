...
- Added `shadcn` named registry for TOUI components with '@TOUI' namespace.
- Migrated to `shadcn` CLI `v3`.
- Added `llms.txt` file for AI assistants and language models to understand TOUI components.
...
- Fixed [Issue #29](https://github.com/keenthemes/TOUI/issues/29).
...
- Fixed [Issue #15](https://github.com/keenthemes/TOUI/issues/15).
- Improve File Upload Hook Error Handling & Performance [PR #28](https://github.com/keenthemes/TOUI/pull/28).
...
- Fixed [Issue #19](https://github.com/keenthemes/TOUI/issues/19).
...
- Fixed [Issue #15](https://github.com/keenthemes/TOUI/issues/15).
- Fixed [Issue #16](https://github.com/keenthemes/TOUI/issues/16).
